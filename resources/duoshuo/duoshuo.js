...
(function(e, t, n) {
    ...
    function() {
        ...
        J.commentList = function(e, t) {
            ...
            function(e) {
                var n = K(e);
                return '<li class="ds-comment' + (t.show_avatars ? " ds-show-avatars": "") + '" data-post-id="' + e.post_id + '">' + (t.show_avatars ? '<div class="ds-avatar">' + J.avatar(n, t.avatar_size) + "</div>": "") + '<div class="ds-meta">' + J.userAnchor(n) + (t.show_time ? J.timeHtml(e.created_at) : "") + "</div>" + (t.show_title ? '<div class="ds-thread-title">\u5728 <a href="' + p(e.thread.url.substring(0,e.thread.url.length-1) + "#comments") + '">' + p(e.thread.title) + '</a> \u4e2d\u8bc4\u8bba</div><div class="ds-excerpt">' + e.message + "</div>": '<a class="ds-excerpt" title="' + p(e.thread.title) + ' \u4e2d\u7684\u8bc4\u8bba" href="' + p(e.thread.url.substring(0,((t.charAt(t.length-1)!="/")?e.thread.url:(e.thread.url.length-1))) + "#comments") + '">' + e.message + "</a>") + "</li>"
            }).join("")
        },
