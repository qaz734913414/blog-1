    ...
    function() {
            ...
            var t = {
                "unread-comments": {
                    ...
                    tmpl: function(e) {
                    	...
                    	var _url = url.substring(0,((url.charAt(url.length-1)!="/")?url.length:(url.length-1))) + "#comments";
        ...
        J.commentList = function(e, t) {
            ...
            function(e) {
                var n = K(e);
                var url = e.thread.url;
            	var _url = p(url.substring(0,((url.charAt(url.length-1)!="/")?url.length:(url.length-1))) + "#comments");
