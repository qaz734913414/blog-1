(function(e, t, n) {
	...
	function ua(e) {
		...
		if (r = e.match(/MSIE\s([^\s|;]+)/gi)) {
			outputer = '<img src="/resources/duoshuo/images/browser/ie.png" title="Internet Explorer"/>' 
		} else if (r = e.match(/FireFox\/([^\s]+)/ig)) {
			var r1 = r[0].split("/");
			outputer = '<img src="/resources/duoshuo/images/browser/firefox.png" title="Mozilla FireFox"/> ' 
		} else if (r = e.match(/Maxthon([\d]*)\/([^\s]+)/ig)) {
			var r1 = r[0].split("/");
			outputer = '<img src="/resources/duoshuo/images/browser/maxthon.png" title="Maxthon"/>' 
		} else if (r = e.match(/Chrome([\d]*)\/([^\s]+)/ig)) {
			var r1 = r[0].split("/");
			outputer = '<img src="/resources/duoshuo/images/browser/chrome.png" title="Chrome"/>' 
		} else if (r = e.match(/QQBrowser\/([^\s]+)/ig)) {
			var r1 = r[0].split("/");
			outputer = '<img src="/resources/duoshuo/images/browser/qq.png" title="QQ浏览器"/>' 
		} else if (r = e.match(/UC/ig)) {
			outputer = '<img src="/resources/duoshuo/images/browser/uc.png" title="UC浏览器"/>'
		} else if (r = e.match(/safari\/([^\s]+)/ig)) {
			var r1 = r[0].split("/");
			outputer = '<img src="/resources/duoshuo/images/browser/safari.png" title="Apple Safari"/>' 
		} else if (r = e.match(/Opera[\s|\/]([^\s]+)/ig)) {
			outputer = '<img src="/resources/duoshuo/images/browser/opera.png" title="Opera"/>' 
		} else {
			//outputer = 'other'
			outputer = '<img src="/resources/duoshuo/images/browser/ie.png" title="Internet Explorer"/>' 
		}
	...
	function os(e) {
		...
		if (e.match(/win/ig)) {
			if (e.match(/nt 5.1/ig)) {
				os = '<img src="/resources/duoshuo/images/os/xp.png" title="windows xp"/>'
			} else if (e.match(/nt 6.1/ig)) {
				os = '<img src="/resources/duoshuo/images/os/win7.png" title="windows 7"/>'
			} else if (e.match(/nt 6.2/ig)) {
				os = '<img src="/resources/duoshuo/images/os/win8.png" title="windows 8"/>'
			} else if (e.match(/nt 6.0/ig)) {
				os = '<img src="/resources/duoshuo/images/os/vista.png" title="vista"/>'
			} else if (e.match(/nt 5/ig)) {
				os = '<img src="/resources/duoshuo/images/os/win2000.png" title="win2000"/>'
			} else {
				//os = 'windows'
				os = '<img src="/resources/duoshuo/images/os/win8.png" title="windows"/>'
			}
		} else if (e.match(/android/ig)) {
			os = '<img src="/resources/duoshuo/images/os/android.png" title="Android"/>'
		} else if (e.match(/ubuntu/ig)) {
			os = '<img src="/resources/duoshuo/images/os/ubuntu.png" title="Ubuntu"/>'
		} else if (e.match(/linux/ig)) {
			os = '<img src="/resources/duoshuo/images/os/linux.png" title="Linux"/>'
		} else if (e.match(/mac/ig)) {
			os = '<img src="/resources/duoshuo/images/os/mac.png" title="Apple"/>'
		} else if (e.match(/unix/ig)) {
			os = '<img src="/resources/duoshuo/images/os/unix.png" title="Unix"/>'
		} else if (e.match(/symbian/ig)) {
			os = '<img src="/resources/duoshuo/images/os/symbian.png" title="Symbian"/>'
		} else {
			//os = 'other'
			os = '<img src="/resources/duoshuo/images/os/linux.png" title="Linux"/>'
		}
	...
	var r = e.location,
		...
		b = e.DUOSHUO = {
			...
			libs: {
				...
				smilies: y + "/libs/smilies.js?921e8eda.js",
	...
	var $ = b.templates = {
		...
		avatar: function(e, t) {
			var n = $.avatarImg(e, t),
				r = $.userUrl(e);
			return r ? '<a rel="nofollow author" target="_blank" href="' + h(r) + '" ' + ' title="' + h(e.name) + '  [' + h(r) + ']' + '">' + n + "</a>" : n
		},
	...
	et.on("queryDefined", function() {
		...
		var i = b.jQuery,
			...
			c = b.loadRequire = function(e) {
				...
				e.style && b.setCustomStyle((e.style || "") + b.compileStyle(U.component_style)), e.unread && rt.reset(e.unread)
			}, m = function(e) {
				e.stopPropagation()
			}, g = function(e) {
